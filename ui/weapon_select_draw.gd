...
func _draw() -> void:
	...
	# Hint
	draw_string(ThemeDB.fallback_font, Vector2(Config.SCREEN_W / 2.0 - 220, Config.SCREEN_H - 55), "武器を選んで5分間生き残れ! (2〜5キー)", HORIZONTAL_ALIGNMENT_LEFT, -1, 18, Color(0.5, 0.5, 0.6))
